...
const char* topic_subscribe2 = "ha/1F/garage/switch123"; 
...
void loop() {
    ...
    if (true==WiFi_connected)
	{
		...
		if (true==topic_subscribe1_flag)
		{
			...
			Serial.print("Garage_states_msg = ");
			Serial.println(Garage_states_msg);
		...
		/*
		if (Garage_states!=prevGarage_states)
		{
			prevGarage_states = Garage_states;
			if (1==Garage_states)
			{
...
{
/*	
  if (true==MQTT_ignore_flag)
  {
	  Serial.println("Ignore MQTT command");
	  MQTT_ignore_flag = false;
	  return;
  }
*/
  payload[length] = '\0';  
